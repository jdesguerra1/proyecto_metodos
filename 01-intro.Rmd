...
df %>%
  ...
  theme_bw() +
  theme(legend.position = "none") # Ocultamos la leyenda porque el eje X ya lo indica
```
-------------------------------------
INTERPRETACION DE ESA TABLA ^^^^^^^^^
-------------------------------------
...
p1 <- df %>%
  ...
  geom_boxplot(fill = "#e67e22",color = "darkred", outlier.color = 'black')+
...
df %>%
  ...
  geom_boxplot(fill = "#9b5e4f", color = "black", outlier.color = 'red', alpha = 0.8) +
...
# Promedio de rendimiento de combustible (ciudad y carretera)
