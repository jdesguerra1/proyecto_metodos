...
>>>>>>> 442d860 (Commit trabajo terminado)
  theme_bw()
```
...
Estos resultados demuestran que el estilo de carrocería ejerce una influencia notable sobre la valuación de los automóviles, aportando información discriminatoria clave que será de gran utilidad como variable predictiva en los modelos de regresión.
